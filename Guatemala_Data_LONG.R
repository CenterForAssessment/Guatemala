...
Guatemala_Data_LONG[GRADE %in% c("0", "4") & ACHIEVEMENT_LEVEL_ORIGINAL=="0", ACHIEVEMENT_LEVEL:=NA]
Guatemala_Data_LONG[GRADE %in% c("0", "4") & ACHIEVEMENT_LEVEL_ORIGINAL=="1", ACHIEVEMENT_LEVEL:=tmp.achievement_levels[1]]
Guatemala_Data_LONG[GRADE %in% c("0", "4") & ACHIEVEMENT_LEVEL_ORIGINAL=="2", ACHIEVEMENT_LEVEL:=tmp.achievement_levels[2]]
Guatemala_Data_LONG[GRADE %in% c("0", "4") & ACHIEVEMENT_LEVEL_ORIGINAL=="3", ACHIEVEMENT_LEVEL:=tmp.achievement_levels[3]]
Guatemala_Data_LONG[GRADE %in% c("0", "4") & ACHIEVEMENT_LEVEL_ORIGINAL=="4", ACHIEVEMENT_LEVEL:=tmp.achievement_levels[4]]
